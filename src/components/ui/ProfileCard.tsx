// React Bits ProfileCard, typed and trimmed for this project.
// Tilts toward the cursor and lights a glow behind itself.
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(() => ({
    ...
    '--behind-glow-color': behindGlowColor ?? 'rgba(52, 211, 153, 0.6)',
