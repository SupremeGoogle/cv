...
const iconComponents: Record<IconType, { component: () => React.JSX.Element; color: string }> = {
  ...
  nodejs: {
    ...
    python: {
    component: () => (
      <svg viewBox="0 0 256 255" fill="none" className="w-full h-full">
        <path d="M126.916 0.157c-65.78 0-61.76 28.533-61.76 28.533l0.066 29.585h62.775v8.892H39.816s-39.66-4.49-39.816 43.834c-0.156 48.324 34.618 46.7 34.618 46.7h20.686v-29.155s-1.127-34.774 34.15-34.774h58.94s32.955 0.525 32.955-31.905V31.97S192.697 0.157 126.916 0.157zm-34.46 19.387a10.975 10.975 0 1 1 0 21.95 10.975 10.975 0 0 1 0-21.95z" fill="#3776AB"/>
        <path d="M128.757 254.673c65.78 0 61.76-28.533 61.76-28.533l-0.066-29.585h-62.775v-8.892h88.181s39.66 4.49 39.816-43.834c0.156-48.324-34.618-46.7-34.618-46.7h-20.686v29.155s1.127 34.774-34.15 34.774h-58.94s-32.955-0.525-32.955 31.905v31.986s-1.347 31.813 64.433 31.813zm34.46-19.387a10.975 10.975 0 1 1 0-21.95 10.975 10.975 0 0 1 0 21.95z" fill="#FFD43B"/>
      </svg>
    ),
    color: '#3776AB'
  },
