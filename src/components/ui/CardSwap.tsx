// React Bits CardSwap, typed for this project.
// A 3D stack of cards where the front one drops away and the rest promote up.
...
const CardSwap = ({
  ...
  const rendered = childArr.map((child, i) => {
    ...
    } as CardProps & { key: number; ref: React.RefObject<HTMLDivElement | null> });
  });
